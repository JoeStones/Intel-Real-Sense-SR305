classdef AcquireRealsense < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        AdquiereButton            matlab.ui.control.Button
    end
    ...
    methods (Access = private)
        ...
        % Boton para Adquirir imagen
        function onAdquiereButton(app, event)     
            % lock drawing process
           app.DrawFlag = 0;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create FotoButton
            app.StopButton = uibutton(app.UIFigure, 'push');
            app.StopButton.ButtonPushedFcn = createCallbackFcn(app, @onAdquiereButton, true);
            app.StopButton.IconAlignment = 'center';
            app.StopButton.Position = [340 22 100 22];
            app.StopButton.Text = 'Foto';
